...
>
> 動画ではAWSでAPIの作成を行います。もし「APIとは何か？」不安がある方は↓の動画を先にご覧いただくと理解がスムーズになります。実際にAWSでAPIを作りながら解説した動画を用意しています。
>
...
複製出来ない人は [前回動画](https://youtu.be/IoeUJG1zfr0) を参考にCSVインポートを試して下さい。
